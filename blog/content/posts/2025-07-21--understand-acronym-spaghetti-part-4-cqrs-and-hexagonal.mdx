...
tags: [programming, architecture, cqrs, hexagonal-architecture, design-patterns, scalability]
---
...
In [Part 3](./understand-acronym-spaghetti-part-3-solid-principles), we covered **SOLID Architecture** principles. Now let's explore **System Architecture** patterns that help you build systems that can scale and evolve.
...
Both patterns build on the SOLID principles from [Part 3](./understand-acronym-spaghetti-part-3-solid-principles) and help you create systems that can adapt to future needs without major rewrites.

**Coming next:** [Part 5](./understand-acronym-spaghetti-part-5-advanced-principles) covers **Advanced Principles** - the subtle patterns that separate good developers from great ones.
